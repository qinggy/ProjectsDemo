    ...
    <div class="box">
        ...
        <ul>
            <% foreach (Assembly assembly in results.AllAssemblies) { %> 
                <% var fva = assembly.GetCustomAttributes(typeof(AssemblyFileVersionAttribute), true).Cast<AssemblyFileVersionAttribute>().FirstOrDefault(); %>

                <li><%= E(assembly) %> [ ver = <%= E((fva != null) ? fva.Version : "n/a") %>, GAC = <%= E(assembly.GlobalAssemblyCache) %> ]</li>
